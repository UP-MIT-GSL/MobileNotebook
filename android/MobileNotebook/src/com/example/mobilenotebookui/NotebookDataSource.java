...
public class NotebookDataSource {
	...
	public Notebook createNotebook(String subject, int pageNumber, String path) {
	...
	public Notebook getNote(){
		Cursor cursor = database.rawQuery("select * from "+NotebookOpenHelper.TABLE_NOTEBOOK,null);
